...
process.MINIAODSIM_sideband_output = cms.OutputModule("PoolOutputModule",
    ...
    eventAutoFlushCompressedSize = cms.untracked.int32(15728640),
    fastCloning = cms.untracked.bool(False),
    fileName = cms.untracked.string('file:realData_emuLowMassRegionSkim.root'),
    outputCommands = process.MICROAODSIMEventContent.outputCommands,
    overrideInputFileSplitLevels = cms.untracked.bool(True),
...
#process.eleMuLowMassSkim = cms.Path(process.emuwRdiLeptonSidebandSeq) #this is the usual selection sequence for the sideband
