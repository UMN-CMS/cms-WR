...
process.MINIAODSIM_signal_output = cms.OutputModule("PoolOutputModule",
		...
		fileName = cms.untracked.string('file:realData_muonSignalRegionSkim.root'),
		outputCommands = process.MICROAODSIMEventContent.outputCommands,
		overrideInputFileSplitLevels = cms.untracked.bool(True),
		SelectEvents = cms.untracked.PSet(SelectEvents = cms.vstring('muonSignalSkim'))
...
process.MINIAODSIM_sideband_output = cms.OutputModule("PoolOutputModule",
    ...
    eventAutoFlushCompressedSize = cms.untracked.int32(15728640),
    fastCloning = cms.untracked.bool(False),
    fileName = cms.untracked.string('file:realData_muonLowMassRegionSkim.root'),
    outputCommands = process.MICROAODSIMEventContent.outputCommands,
    overrideInputFileSplitLevels = cms.untracked.bool(True),
    SelectEvents = cms.untracked.PSet(SelectEvents = cms.vstring('muonLowMassSkim'))
)
...
process.muonSignalSkim = cms.Path(process.wRdiMuonAndFourObjSignalSeq)
process.muonLowMassSkim = cms.Path(process.wRdiMuonAndLowMassSignalSeq)
