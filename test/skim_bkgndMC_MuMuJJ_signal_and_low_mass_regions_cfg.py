...
process.MINIAODSIM_signal_output = cms.OutputModule("PoolOutputModule",
		...
		fileName = cms.untracked.string('file:miniAODMuMuSkimSignalRegion.root'),
		outputCommands = process.MICROAODSIMEventContent.outputCommands,
		overrideInputFileSplitLevels = cms.untracked.bool(True),
		SelectEvents = cms.untracked.PSet(SelectEvents = cms.vstring('muMuSignalSkim'))
...
process.MINIAODSIM_sideband_output = cms.OutputModule("PoolOutputModule",
    ...
    eventAutoFlushCompressedSize = cms.untracked.int32(15728640),
    fastCloning = cms.untracked.bool(False),
    fileName = cms.untracked.string('file:miniAODMuMuSkimLowMassRegion.root'),
    outputCommands = process.MICROAODSIMEventContent.outputCommands,
    overrideInputFileSplitLevels = cms.untracked.bool(True),
    SelectEvents = cms.untracked.PSet(SelectEvents = cms.vstring('muMuLowMassSkim'))
)
...
process.muMuSignalSkim = cms.Path(process.wRdiMuonAndFourObjSignalSeq)
process.muMuLowMassSkim = cms.Path(process.wRdiMuonAndLowMassSignalSeq)
