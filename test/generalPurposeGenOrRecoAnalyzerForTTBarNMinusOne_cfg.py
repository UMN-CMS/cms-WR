...
if (options.channel=='EE'):
	process.analyzeWRdecayGenQuarksWithFlavorReq = cms.Path(process.matchedGenEleAndQuarkFromTTBarSeq*process.genEleChnlGenQuarksNoMatchingSequence*process.analyzerSix)
	process.analyzeWRdecayGenJetsWithFlavorReq = cms.Path(process.matchedGenEleAndQuarkFromTTBarSeq*process.genEleChnlGenJetsNoMatchingSequence*process.analyzerSeven)
...
#
if (options.channel=='MuMu'):
	process.analyzeWRdecayGenQuarksWithFlavorReq = cms.Path(process.matchedGenMuAndQuarkFromTTBarSeq*process.genMuChnlGenQuarksNoMatchingSequence*process.analyzerSix)
	process.analyzeWRdecayGenJetsWithFlavorReq = cms.Path(process.matchedGenMuAndQuarkFromTTBarSeq*process.genMuChnlGenJetsNoMatchingSequence*process.analyzerSeven)
