...
process.load('ExoAnalysis.cmsWR.produceScaleCorrectedMuons_cff')
#process.MuonScale = cms.Path(process.ScaleCorrectedMuonsSequence*process.MuonIdIsoSFProdSequence)
process.load('ExoAnalysis.cmsWR.produceIdIsoSF_cff')
process.MuonScaleIDISO = cms.Path(process.ScaleCorrectedMuonsSequence*process.MuonIdIsoSFProdSequence)


process.microAODoutput_step = cms.EndPath(process.microAOD_output)

############################################################ SCHEDULE
process.schedule = cms.Schedule(process.MuonScaleIDISO,process.microAODoutput_step)
