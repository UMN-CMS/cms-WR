...
#mass=(1000 1200)
#mass=(1400 1600 1800 2000 2200 2400 2600 2800 3000 3200 3600 3800 4000 4200 4400 4600 4800 5000 5200 5600 5800 6000)

##it is best to submit jobs for only one lepton channel at a time
for i in ${!mass[*]}
do
	...
	#submit the job(s)
	#echo "bsub -R 'pool>1500' -q 8nh -J scanMassWindows_ee_MWR_${mass[$i]} < runMassWindowScan_MWR_${mass[$i]}_ee.sh"
	#echo "bsub -R 'pool>1500' -q 8nh -J scanMassWindows_mumu_MWR_${mass[$i]} < runMassWindowScan_MWR_${mass[$i]}_mumu.sh"
