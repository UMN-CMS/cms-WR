...
void ToyThrower(miniTreeEvent *myEvent,  float rand_smear[], float rand_up_down[], int random_seed, std::vector<std::string> list, bool isData, std::string rochesterInitFile)
{
	...
	rochcor2016 *rmcor = new rochcor2016(rochesterInitFile, random_seed);
