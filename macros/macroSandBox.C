...
void makeAndSaveSingleHistoFromTreeWithCuts(TChain * chain,string canvName,string cuts,string treeDrawArgs,string histName,string histTitle,string xAxisTitle,string outputFileName,Float_t efficiencyThreshold){
#ifdef DEBUG
...
///end lowMassFlavorSidebandBkgndOnData
	...
	*/
	...
	string histoEndings[] = {"_genLeptPtFromWR(100,0.,450.)","_genLeptPtFromNu(100,0.,450.)","_genQrkOnePtFromNu(100,0.,450.)","_genQrkTwoPtFromNu(100,0.,450.)","_dileptonMassGenLeptsFromWRandNu(100,0.,850.)","_deltaRgenLeptAndQrkOneFromNu(100,0.,4.5)","_deltaRgenLeptAndQrkTwoFromNu(100,0.,4.5)","_subleadGenLeptNotFromNu(2,0.,2.)"};	//low mass
	...
	//string histoEndings[] = {"_genLeptPtFromWR(100,0.,1850.)","_genLeptPtFromNu(100,0.,1850.)","_genQrkOnePtFromNu(100,0.,1850.)","_genQrkTwoPtFromNu(100,0.,1850.)","_dileptonMassGenLeptsFromWRandNu(100,0.,3400.)","_deltaRgenLeptAndQrkOneFromNu(100,0.,4.5)","_deltaRgenLeptAndQrkTwoFromNu(100,0.,4.5)","_subleadGenLeptNotFromNu(2,0.,2.)"};	//fixed Nu mass
	...
	for(unsigned int i=0; i<maxI; i++){
		...
		makeAndSaveMultipleCurveOverlayHisto(placeHolderMap,cName.c_str(),0.65,0.6,0.95,0.90,true,title,xAxisLabels[i],"_MWR_800_several_MNu_private",true,cutVals[i]);
		placeHolderMap.clear();
	}///end loop over branchNames
...
//end ifdef studyGenWrKinematicsVsWrAndNuMasses
	...
	*/
	...
	//string plotXaxisLabel[] = {"GEN W_{R} Multiplicity","GEN Nu Multiplicity","GEN Lepton Multiplicity","GEN Quark Multiplicity","1 = lead GEN lepton not W_{R} dau","1 = sublead GEN lepton not Nu dau","1 = lead GEN quark not Nu dau","1 = sublead GEN quark not Nu dau","GEN W_{R} #eta","GEN W_{R} P_{T} [GeV]","GEN W_{R} Mass [GeV]","GEN Nu #eta","GEN Nu P_{T} [GeV]","GEN Nu Mass [GeV]","#eta of GEN Lepton from W_{R}","P_{T} [GeV]","#phi","#eta","P_{T} [GeV]","#phi","#eta","P_{T} [GeV]","#phi","#eta","P_{T} [GeV]","#phi","P_{T} [GeV]","#eta","#phi","P_{T} [GeV]","#eta","#phi","P_{T} [GeV]","#eta","#phi","P_{T} [GeV]","#eta","#phi","P_{T} [GeV]","#eta","#phi","P_{T} [GeV]","#eta","#phi","P_{T} [GeV]","#eta","#phi","P_{T} [GeV]","#eta","#phi","P_{T} [GeV]","#eta","#phi","P_{T} [GeV]","#eta","#phi","P_{T} [GeV]","#eta","#phi","P_{T} [GeV]","#eta","#phi","P_{T} [GeV]","#eta","#phi","P_{T} [GeV]","#eta","#phi","GEN W_{R} Rapidity","GEN Nu Rapidity"};
	...
	string plotXaxisLabel[] = {"GEN W_{R} Multiplicity","GEN Nu Multiplicity","GEN Lepton Multiplicity","GEN Quark Multiplicity","1 = lead GEN lepton not W_{R} dau","1 = sublead GEN lepton not Nu dau","1 = lead GEN quark not Nu dau","1 = sublead GEN quark not Nu dau","GEN W_{R} #eta","GEN W_{R} P_{T} [GeV]","GEN W_{R} Mass [GeV]","GEN Nu #eta","GEN Nu P_{T} [GeV]","GEN Nu Mass [GeV]","#eta of GEN Lepton from W_{R}","P_{T} of GEN Lepton from W_{R} [GeV]","#phi of GEN Lepton from W_{R}","#eta of GEN Lepton from Nu","P_{T} of GEN Lepton from Nu [GeV]","#phi of GEN Lepton from Nu","#eta of GEN quark one from Nu","P_{T} of GEN quark one from Nu [GeV]","#phi of GEN quark one from Nu","#eta of GEN quark two from Nu","P_{T} of GEN quark two from Nu [GeV]","#phi of GEN quark two from Nu","P_{T} of leading GEN lepton [GeV]","#eta of leading GEN lepton","#phi of leading GEN lepton","P_{T} of subleading GEN lepton [GeV]","#eta of subleading GEN lepton","#phi of subleading GEN lepton","P_{T} of leading GEN quark [GeV]","#eta of leading GEN quark","#phi of leading GEN quark","P_{T} of subleading GEN quark [GeV]","#eta of subleading GEN quark","#phi of subleading GEN quark", "GEN four object mass [GeV]", "GEN dilepton mass [GeV]", "#DeltaR[Gen Lept from WR, Gen Qrk One from Nu]", "#DeltaR[Gen Lept from WR, Gen Qrk Two from Nu]", "#DeltaR[Gen Lept from Nu, Gen Qrk One from Nu]", "#DeltaR[Gen Lept from Nu, Gen Qrk Two from Nu]"};
	...
	for(int i=0; i<nBins ; i++){
		...
		TChain * wrChain = new TChain("wrDecayChainAnalyzer/genAndMatchedRecoWrDecayNoCuts");
		...
		for(int j=0; j<nBranches ; j++){
			...
			//if(plotArg[j] == "ptGenLeptFromFstHvyPtcl") makeAndSaveSingleHistoFromTreeWithCuts(wrChain,"c"+to_string(j),plotCut[j],plotArg[j]+">>"+plotArg[j]+"Hist()",plotArg[j]+"Hist",stdPlotTitle,plotXaxisLabel[j],plotDir+"_"+plotArg[j],60.);
			//if(plotArg[j] == "ptGenLeptFromScdHvyPtcl") makeAndSaveSingleHistoFromTreeWithCuts(wrChain,"c"+to_string(j),plotCut[j],plotArg[j]+">>"+plotArg[j]+"Hist()",plotArg[j]+"Hist",stdPlotTitle,plotXaxisLabel[j],plotDir+"_"+plotArg[j],50.);
			//if(plotArg[j] == "ptGenQuarkOneFromScdHvyPtcl") makeAndSaveSingleHistoFromTreeWithCuts(wrChain,"c"+to_string(j),plotCut[j],plotArg[j]+">>"+plotArg[j]+"Hist()",plotArg[j]+"Hist",stdPlotTitle,plotXaxisLabel[j],plotDir+"_"+plotArg[j],40.);
			//if(plotArg[j] == "ptGenQuarkTwoFromScdHvyPtcl") makeAndSaveSingleHistoFromTreeWithCuts(wrChain,"c"+to_string(j),plotCut[j],plotArg[j]+">>"+plotArg[j]+"Hist()",plotArg[j]+"Hist",stdPlotTitle,plotXaxisLabel[j],plotDir+"_"+plotArg[j],40.);

			//calculate efficiency of four object mass cut
			if(plotArg[j] == "fourObjMassFromGenObjsFromFstAndScdHvyPtcl") makeAndSaveSingleHistoFromTreeWithCuts(wrChain,"c"+to_string(j),plotCut[j],plotArg[j]+">>"+plotArg[j]+"Hist()",plotArg[j]+"Hist",stdPlotTitle,plotXaxisLabel[j],plotDir+"_"+plotArg[j],600.);

			//make and save plots from each branch of the input tree
			makeAndSaveSingleHistoFromTreeWithCuts(wrChain,"c"+to_string(j),plotCut[j],plotArg[j]+">>"+plotArg[j]+"Hist()",plotArg[j]+"Hist",stdPlotTitle,plotXaxisLabel[j],plotDir+"_"+plotArg[j],0.);
		...
		//makeAndSaveSingleHistoFromTreeWithCuts(wrChain,"r5",cutsSubleadLeptNotFromWRorNu,"motherPdgIdSubleadGenLepton>>motherPdgIdSubleadGenLeptonHist(80,-40.,40.)","motherPdgIdSubleadGenLeptonHist","mother PdgId of sublead GEN lepton when sublead GEN lepton is not from W_{R} or Nu","mother PdgId of sublead GEN lepton",plotDir+"_motherPdgIdSubleadGenLepton_subleadGenLeptNotFromWrOrNu",-2);
		//makeAndSaveSingleHistoFromTreeWithCuts(wrChain,"r6",cutsSubleadLeptNotFromWRorNu,"motherStatusSubleadGenLepton>>motherStatusSubleadGenLeptonHist(56,-1.,55.)","motherStatusSubleadGenLeptonHist","mother Status of sublead GEN lepton when sublead GEN lepton is not from W_{R} or Nu","mother Status of sublead GEN lepton",plotDir+"_motherStatusSubleadGenLepton_subleadGenLeptNotFromWrOrNu",-2);
...
#ifdef checkMinitreeContents
	//check which WRtoEEJJ minitree files have nonzero entries in the signal mumu minitree
	TString treeName = "miniTree_signal_mumu/t";
	string inputFileDir = "../";
	string fileNames[] = {"WRtoEEJJ_4000_800_PrivReco_Part1.root", "WRtoEEJJ_4000_800_PrivReco_Part10.root", "WRtoEEJJ_4000_800_PrivReco_Part100.root", "WRtoEEJJ_4000_800_PrivReco_Part102.root", "WRtoEEJJ_4000_800_PrivReco_Part103.root", "WRtoEEJJ_4000_800_PrivReco_Part107.root", "WRtoEEJJ_4000_800_PrivReco_Part108.root", "WRtoEEJJ_4000_800_PrivReco_Part109.root", "WRtoEEJJ_4000_800_PrivReco_Part11.root", "WRtoEEJJ_4000_800_PrivReco_Part110.root", "WRtoEEJJ_4000_800_PrivReco_Part111.root", "WRtoEEJJ_4000_800_PrivReco_Part114.root", "WRtoEEJJ_4000_800_PrivReco_Part115.root", "WRtoEEJJ_4000_800_PrivReco_Part117.root", "WRtoEEJJ_4000_800_PrivReco_Part118.root", "WRtoEEJJ_4000_800_PrivReco_Part119.root", "WRtoEEJJ_4000_800_PrivReco_Part12.root", "WRtoEEJJ_4000_800_PrivReco_Part120.root", "WRtoEEJJ_4000_800_PrivReco_Part122.root", "WRtoEEJJ_4000_800_PrivReco_Part125.root", "WRtoEEJJ_4000_800_PrivReco_Part127.root", "WRtoEEJJ_4000_800_PrivReco_Part13.root", "WRtoEEJJ_4000_800_PrivReco_Part131.root", "WRtoEEJJ_4000_800_PrivReco_Part132.root", "WRtoEEJJ_4000_800_PrivReco_Part134.root", "WRtoEEJJ_4000_800_PrivReco_Part135.root", "WRtoEEJJ_4000_800_PrivReco_Part138.root", "WRtoEEJJ_4000_800_PrivReco_Part139.root", "WRtoEEJJ_4000_800_PrivReco_Part14.root", "WRtoEEJJ_4000_800_PrivReco_Part140.root", "WRtoEEJJ_4000_800_PrivReco_Part141.root", "WRtoEEJJ_4000_800_PrivReco_Part142.root", "WRtoEEJJ_4000_800_PrivReco_Part143.root", "WRtoEEJJ_4000_800_PrivReco_Part144.root", "WRtoEEJJ_4000_800_PrivReco_Part146.root", "WRtoEEJJ_4000_800_PrivReco_Part148.root", "WRtoEEJJ_4000_800_PrivReco_Part149.root", "WRtoEEJJ_4000_800_PrivReco_Part151.root", "WRtoEEJJ_4000_800_PrivReco_Part153.root", "WRtoEEJJ_4000_800_PrivReco_Part154.root", "WRtoEEJJ_4000_800_PrivReco_Part155.root", "WRtoEEJJ_4000_800_PrivReco_Part156.root", "WRtoEEJJ_4000_800_PrivReco_Part157.root", "WRtoEEJJ_4000_800_PrivReco_Part159.root", "WRtoEEJJ_4000_800_PrivReco_Part16.root", "WRtoEEJJ_4000_800_PrivReco_Part160.root", "WRtoEEJJ_4000_800_PrivReco_Part161.root", "WRtoEEJJ_4000_800_PrivReco_Part163.root", "WRtoEEJJ_4000_800_PrivReco_Part165.root", "WRtoEEJJ_4000_800_PrivReco_Part166.root", "WRtoEEJJ_4000_800_PrivReco_Part169.root", "WRtoEEJJ_4000_800_PrivReco_Part17.root", "WRtoEEJJ_4000_800_PrivReco_Part170.root", "WRtoEEJJ_4000_800_PrivReco_Part171.root", "WRtoEEJJ_4000_800_PrivReco_Part172.root", "WRtoEEJJ_4000_800_PrivReco_Part173.root", "WRtoEEJJ_4000_800_PrivReco_Part176.root", "WRtoEEJJ_4000_800_PrivReco_Part177.root", "WRtoEEJJ_4000_800_PrivReco_Part178.root", "WRtoEEJJ_4000_800_PrivReco_Part179.root", "WRtoEEJJ_4000_800_PrivReco_Part18.root", "WRtoEEJJ_4000_800_PrivReco_Part182.root", "WRtoEEJJ_4000_800_PrivReco_Part184.root", "WRtoEEJJ_4000_800_PrivReco_Part189.root", "WRtoEEJJ_4000_800_PrivReco_Part19.root", "WRtoEEJJ_4000_800_PrivReco_Part191.root", "WRtoEEJJ_4000_800_PrivReco_Part2.root", "WRtoEEJJ_4000_800_PrivReco_Part204.root", "WRtoEEJJ_4000_800_PrivReco_Part208.root", "WRtoEEJJ_4000_800_PrivReco_Part209.root", "WRtoEEJJ_4000_800_PrivReco_Part21.root", "WRtoEEJJ_4000_800_PrivReco_Part213.root", "WRtoEEJJ_4000_800_PrivReco_Part216.root", "WRtoEEJJ_4000_800_PrivReco_Part219.root", "WRtoEEJJ_4000_800_PrivReco_Part22.root", "WRtoEEJJ_4000_800_PrivReco_Part221.root", "WRtoEEJJ_4000_800_PrivReco_Part226.root", "WRtoEEJJ_4000_800_PrivReco_Part228.root", "WRtoEEJJ_4000_800_PrivReco_Part23.root", "WRtoEEJJ_4000_800_PrivReco_Part232.root", "WRtoEEJJ_4000_800_PrivReco_Part233.root", "WRtoEEJJ_4000_800_PrivReco_Part24.root", "WRtoEEJJ_4000_800_PrivReco_Part241.root", "WRtoEEJJ_4000_800_PrivReco_Part243.root", "WRtoEEJJ_4000_800_PrivReco_Part246.root", "WRtoEEJJ_4000_800_PrivReco_Part248.root", "WRtoEEJJ_4000_800_PrivReco_Part25.root", "WRtoEEJJ_4000_800_PrivReco_Part250.root", "WRtoEEJJ_4000_800_PrivReco_Part259.root", "WRtoEEJJ_4000_800_PrivReco_Part273.root", "WRtoEEJJ_4000_800_PrivReco_Part28.root", "WRtoEEJJ_4000_800_PrivReco_Part282.root", "WRtoEEJJ_4000_800_PrivReco_Part285.root", "WRtoEEJJ_4000_800_PrivReco_Part287.root", "WRtoEEJJ_4000_800_PrivReco_Part288.root", "WRtoEEJJ_4000_800_PrivReco_Part29.root", "WRtoEEJJ_4000_800_PrivReco_Part293.root", "WRtoEEJJ_4000_800_PrivReco_Part296.root", "WRtoEEJJ_4000_800_PrivReco_Part297.root", "WRtoEEJJ_4000_800_PrivReco_Part3.root", "WRtoEEJJ_4000_800_PrivReco_Part30.root", "WRtoEEJJ_4000_800_PrivReco_Part31.root", "WRtoEEJJ_4000_800_PrivReco_Part32.root", "WRtoEEJJ_4000_800_PrivReco_Part321.root", "WRtoEEJJ_4000_800_PrivReco_Part328.root", "WRtoEEJJ_4000_800_PrivReco_Part33.root", "WRtoEEJJ_4000_800_PrivReco_Part332.root", "WRtoEEJJ_4000_800_PrivReco_Part34.root", "WRtoEEJJ_4000_800_PrivReco_Part347.root", "WRtoEEJJ_4000_800_PrivReco_Part35.root", "WRtoEEJJ_4000_800_PrivReco_Part36.root", "WRtoEEJJ_4000_800_PrivReco_Part37.root", "WRtoEEJJ_4000_800_PrivReco_Part38.root", "WRtoEEJJ_4000_800_PrivReco_Part39.root", "WRtoEEJJ_4000_800_PrivReco_Part4.root", "WRtoEEJJ_4000_800_PrivReco_Part41.root", "WRtoEEJJ_4000_800_PrivReco_Part42.root", "WRtoEEJJ_4000_800_PrivReco_Part43.root", "WRtoEEJJ_4000_800_PrivReco_Part45.root", "WRtoEEJJ_4000_800_PrivReco_Part46.root", "WRtoEEJJ_4000_800_PrivReco_Part47.root", "WRtoEEJJ_4000_800_PrivReco_Part48.root", "WRtoEEJJ_4000_800_PrivReco_Part49.root", "WRtoEEJJ_4000_800_PrivReco_Part5.root", "WRtoEEJJ_4000_800_PrivReco_Part50.root", "WRtoEEJJ_4000_800_PrivReco_Part51.root", "WRtoEEJJ_4000_800_PrivReco_Part52.root", "WRtoEEJJ_4000_800_PrivReco_Part54.root", "WRtoEEJJ_4000_800_PrivReco_Part55.root", "WRtoEEJJ_4000_800_PrivReco_Part56.root", "WRtoEEJJ_4000_800_PrivReco_Part57.root", "WRtoEEJJ_4000_800_PrivReco_Part6.root", "WRtoEEJJ_4000_800_PrivReco_Part60.root", "WRtoEEJJ_4000_800_PrivReco_Part61.root", "WRtoEEJJ_4000_800_PrivReco_Part62.root", "WRtoEEJJ_4000_800_PrivReco_Part65.root", "WRtoEEJJ_4000_800_PrivReco_Part66.root", "WRtoEEJJ_4000_800_PrivReco_Part68.root", "WRtoEEJJ_4000_800_PrivReco_Part7.root", "WRtoEEJJ_4000_800_PrivReco_Part70.root", "WRtoEEJJ_4000_800_PrivReco_Part71.root", "WRtoEEJJ_4000_800_PrivReco_Part74.root", "WRtoEEJJ_4000_800_PrivReco_Part76.root", "WRtoEEJJ_4000_800_PrivReco_Part77.root", "WRtoEEJJ_4000_800_PrivReco_Part78.root", "WRtoEEJJ_4000_800_PrivReco_Part79.root", "WRtoEEJJ_4000_800_PrivReco_Part8.root", "WRtoEEJJ_4000_800_PrivReco_Part80.root", "WRtoEEJJ_4000_800_PrivReco_Part81.root", "WRtoEEJJ_4000_800_PrivReco_Part82.root", "WRtoEEJJ_4000_800_PrivReco_Part83.root", "WRtoEEJJ_4000_800_PrivReco_Part84.root", "WRtoEEJJ_4000_800_PrivReco_Part85.root", "WRtoEEJJ_4000_800_PrivReco_Part86.root", "WRtoEEJJ_4000_800_PrivReco_Part87.root", "WRtoEEJJ_4000_800_PrivReco_Part89.root", "WRtoEEJJ_4000_800_PrivReco_Part9.root", "WRtoEEJJ_4000_800_PrivReco_Part93.root", "WRtoEEJJ_4000_800_PrivReco_Part94.root", "WRtoEEJJ_4000_800_PrivReco_Part95.root", "WRtoEEJJ_4000_800_PrivReco_Part97.root", "WRtoEEJJ_4000_800_PrivReco_Part99.root"};
	
	vector<string> vectForFiles(fileNames,fileNames + sizeof(fileNames)/sizeof(string));
	int nFiles = vectForFiles.size();

	for(int i=0; i<nFiles; i++){
		TChain * minitree = new TChain(treeName);
		minitree->Add((inputFileDir+fileNames[i]).c_str());
		if(minitree->GetEntries() > 0){
			std::cout<<"file named "<< fileNames[i] << " has at least 1 evt in the signal mumu minitree"<<std::endl;
			break;
		}

		delete minitree;
	}//end loop over minitree files


#endif
	//end checkMinitreeContents
