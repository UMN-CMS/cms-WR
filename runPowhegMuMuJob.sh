...
#bsub -R "rusage[mem=8000]" -q 8nh -J powhegMuMu < runPowhegMuMuJob.sh
#to request 8 GB ram
...
eval 'make'
eval "./bin/analysis -m DYPOWHEG -c MuMu --toys 150 --nStatToys 150 --ignoreDyScaleFactors false"
eval "mv ./selected_tree_DYPOWHEG_signal_mumuMuMu_withMllWeight.root $finalDir/."
