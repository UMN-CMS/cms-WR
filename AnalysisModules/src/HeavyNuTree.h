...
public:
   ...
   HeavyNuTree(TDirectory& f, bool writable) : m_file(f)
   {
      ...
      if(writable)
      {
         ...
         branch_ = m_tree->Branch("slopefit", &event_, "mlljj/F:mll:weight:l1pt:l1eta:l1phi:l1jdR:l2pt:l2eta:l2phi:l2jdR:j1pt:j1eta:j1phi:j2pt:j2eta:j2phi:flavor/S:l1id:l2id:cutlevel:npu:npv");
      }
      else
      {
