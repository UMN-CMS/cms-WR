...
void loadSystematics() {
  ...
  systematics10[i_OTHER]["UNCOTHER"]=1.26; // QCD plus Other MC Stats
  ...
  systematics10[i_SIGNAL]["RECOCAL10"]=1+sqrt(pow(0.08,2)+pow(0.02,2)+
					      pow(0.10,2));
  systematics10[i_TT]["RECOCAL10"]=1+sqrt(pow(0.11,2)+pow(0.04,2)+
					  pow(0.10,2));
  systematics10[i_ZJ]["RECOCAL10"]=1+sqrt(pow(0.03,2)+pow(0.03,2)+
					  pow(0.10,2));
  systematics10[i_OTHER]["RECOCAL10"]=1+sqrt(pow(0.10,2)+pow(0.09,2)+
					     pow(0.10,2));


  systematics11[i_SIGNAL]["RECOCAL11"]=1+sqrt(pow(0.08,2)+pow(0.02,2)+
					      pow(0.10,2));
  systematics11[i_TT]["RECOCAL11"]=1+sqrt(pow(0.11,2)+pow(0.04,2)+
					  pow(0.10,2));
  systematics11[i_ZJ]["RECOCAL11"]=1+sqrt(pow(0.05,2)+pow(0.03,2)+
					  pow(0.10,2));
  systematics11[i_OTHER]["RECOCAL11"]=1+sqrt(pow(0.12,2)+pow(0.09,2)+
					     pow(0.10,2));
