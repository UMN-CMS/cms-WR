...
int main(int argc, char* argv[])
{
    ...
    if (pt.mode == LimitPoint::lp_MuonElec)
    {
        ...
        syst1.standardSystematics("EMUM"); // define the standard systematics
        syst2.load(systf_name[1].c_str());
        syst2.standardSystematics("EMUE"); // define the standard systematics 
    ...
    else
    {
        ...
        if(pt.mode == LimitPoint::lp_Muon1ECM)      syst.standardSystematics("MUON"); // define the standard systematics 
        else if(pt.mode == LimitPoint::lp_Elec1ECM) syst.standardSystematics("ELEC"); // define the standard systematics
        /*
          if (argc==10)
