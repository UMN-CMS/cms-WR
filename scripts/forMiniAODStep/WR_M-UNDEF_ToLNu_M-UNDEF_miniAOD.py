...
# with command line options: --mc --step PAT --filein=file:WR_M-2400_ToLNu_M-1200_RECO_13TeV_1.root --fileout=file:WR_M-2400_ToLNu_M-1200_miniAOD_13TeV_1.root --python_filename=WR_M-2400_ToLNu_M-1200_miniAOD_EEJJ.py --eventcontent MINIAODSIM --datatier MINIAODSIM --conditions=80X_mcRun2_asymptotic_v14 --era=Run2_2016 --runUnscheduled --no_exec -n 100
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:WR_M-2400_ToLNu_M-1200_RECO_13TeV_1.root'),
