...
eval "mv WR_MWR_MMAASS_ToLNu_MNu_MASSNU_GEN_13TeV_NUM.root /tmp/skalafut/."
eval "cmsRun test/checkWRDecay_crabSafe_cfg.py channel=CHNL files=file:/tmp/skalafut/WR_MWR_MMAASS_ToLNu_MNu_MASSNU_GEN_13TeV_NUM.root output=OUTPATH/analyzed_SMPL_MMAASS_NU_MASSNU_NUM.root"
#rm WR_M-MMAASS_ToLNu_M-MASSNU_GEN_NUM.py WR_MWR_MMAASS_ToLNu_MNu_MASSNU_GEN_13TeV_NUM.root
rm WR_M-MMAASS_ToLNu_M-MASSNU_GEN_NUM.py /tmp/skalafut/WR_MWR_MMAASS_ToLNu_MNu_MASSNU_GEN_13TeV_NUM.root
