...
mv WR_M-MASSWR_ToLNu_M-MASSNU_miniAOD_13TeV-2016_EEJJ_NUM.root /tmp/skalafut/.
...
eval "cd ../../"
eval "cmsRun test/temp_skims_cfg.py files=file:/tmp/skalafut/WR_M-MASSWR_ToLNu_M-MASSNU_miniAOD_13TeV-2016_EEJJ_NUM.root output=WRtoEEJJ_MASSWR_MASSNU_PrivReco_skimPartNUM.root"
mv WRtoEEJJ_MASSWR_MASSNU_PrivReco_skimPartNUM.root /tmp/skalafut/.
rm /tmp/skalafut/WR_M-MASSWR_ToLNu_M-MASSNU_miniAOD_13TeV-2016_EEJJ_NUM.root

#process WR skim file into WR minitrees
eval "cmsRun test/temp_runAnalysis_cfg.py isMC=1 datasetTag=WRtoEEJJ_MASSWR_MASSNU_PrivReco files=file:/tmp/skalafut/WRtoEEJJ_MASSWR_MASSNU_PrivReco_skimPartNUM.root output=WRtoEEJJ_MASSWR_MASSNU_PrivReco_PartNUM.root"
rm /tmp/skalafut/WRtoEEJJ_MASSWR_MASSNU_PrivReco_skimPartNUM.root
