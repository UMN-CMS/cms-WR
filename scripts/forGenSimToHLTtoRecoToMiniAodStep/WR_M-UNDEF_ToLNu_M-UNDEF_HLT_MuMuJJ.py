...
process.load('ExoAnalysis.cmsWR.HLT_25ns10e33_v2_cff')
...
process.source = cms.Source("PoolSource",
		...
		fileNames = cms.untracked.vstring('file:/tmp/skalafut/WR_M-MASSWR_ToLNu_M-MASSNU_GEN-SIM_13TeV-2016_MuMuJJ_NUM.root'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
		...
		fileName = cms.untracked.string('file:WR_M-MASSWR_ToLNu_M-MASSNU_RAWSIM_13TeV-2016_MuMuJJ_NUM.root'),
