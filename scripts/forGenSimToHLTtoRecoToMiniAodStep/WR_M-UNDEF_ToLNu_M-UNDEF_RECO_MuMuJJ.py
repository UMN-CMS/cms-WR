...
process.source = cms.Source("PoolSource",
		fileNames = cms.untracked.vstring('file:/tmp/skalafut/WR_M-MASSWR_ToLNu_M-MASSNU_RAWSIM_13TeV-2016_MuMuJJ_NUM.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
		...
		fileName = cms.untracked.string('file:WR_M-MASSWR_ToLNu_M-MASSNU_AODSIM_13TeV-2016_MuMuJJ_NUM.root'),
