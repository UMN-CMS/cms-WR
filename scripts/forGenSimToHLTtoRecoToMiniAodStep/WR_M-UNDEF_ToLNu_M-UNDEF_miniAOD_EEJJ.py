...
process.source = cms.Source("PoolSource",
		fileNames = cms.untracked.vstring('file:/tmp/skalafut/WR_M-MASSWR_ToLNu_M-MASSNU_AODSIM_13TeV-2016_EEJJ_NUM.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
		...
		fileName = cms.untracked.string('file:WR_M-MASSWR_ToLNu_M-MASSNU_miniAOD_13TeV-2016_EEJJ_NUM.root'),
