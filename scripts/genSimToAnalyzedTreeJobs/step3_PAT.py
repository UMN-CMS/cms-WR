...
# with command line options: step3 --filein file:TEST_OUTPUT.root --fileout file:eejj_WRSignal.root --mc --eventcontent MINIAODSIM --runUnscheduled --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --conditions auto:run2_mc --step PAT --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:eejjSignalRegion_reco.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:eejjSignalRegion_WR_Signal.root'),
