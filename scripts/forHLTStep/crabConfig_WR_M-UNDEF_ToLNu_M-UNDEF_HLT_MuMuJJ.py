...
config.General.requestName = 'WR_M-UNDEF_ToLNu_M-UNDEF_2016-MCproductionHLT_MuMuJJ' 
...
config.Data.outputDatasetTag = 'WR-MUNDEF_ToLNu-MUNDEF_ToMuMuJJ_HLT_13TeV-2016' 
