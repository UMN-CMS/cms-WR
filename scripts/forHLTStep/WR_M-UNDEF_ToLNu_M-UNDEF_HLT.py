...
# with command line options: --mc --step DIGI,L1,DIGI2RAW,HLT:25ns10e33_v2 --filein=file:WR_M-2400_ToLNu_M-1200_GEN_SIM_13TeV_1.root --fileout=file:WR_M-2400_ToLNu_M-1200_HLT_13TeV_1.root --python_filename=WR_M-2400_ToLNu_M-1200_HLT_EEJJ.py --eventcontent=RAWSIM --datatier=GEN-SIM-RAW --conditions=80X_mcRun2_asymptotic_v14 --era=Run2_2016 --pileup_input=dbs:/MinBias_TuneCUETP8M1_13TeV-pythia8/RunIISummer15GS-MCRUN2_71_V1-v2/GEN-SIM --pileup=Flat_10_50_25ns -n 100 --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:WR_M-2400_ToLNu_M-1200_GEN_SIM_13TeV_1.root'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:WR_M-MASSWR_ToLNu_M-MASSNU_HLT_13TeV-2016.root'),
