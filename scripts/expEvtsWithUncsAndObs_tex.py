...
header = " & \\multicolumn{5}{c|}{Electron channel}  \\\\\n \\MWR (GeV) & Signal (mean $\\pm$ stat \\pm syst) & $Z/\\gamma^*$ (mean $\\pm$ stat $\\pm$ syst) & Top quark (mean $\\pm$ stat $\\pm$ syst) & All BG (mean $\\pm$ stat $\\pm$ syst) & Data \\\\\\hline\n"
