...
#	y_title="Limit on XS(pb)", y_limits = (2e-3,6e-2), x_limits = (800, 4000), leg_y = .68 )
plotters["ee"].plot("plots/limWReejjNarrowRange" + name + tag, x_title = "M_{W_{R}} [GeV]",
	y_title="Limit on XS(fb)", y_limits = (2e+0,4e+2), x_limits = (2000, 3000), leg_y = .68 , scale = 1000)
plotters["mumu"].plot("plots/limWRmumujjNarrowRange" + name + tag, x_title = "M_{W_{R}} [GeV]",
	y_title="Limit on XS(fb)", y_limits = (2e+0,4e+2), x_limits = (2000, 3000), leg_y = .68 , scale = 1000)
