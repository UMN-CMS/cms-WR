...
##eval "./bin/analysis -c MuMu --ignoreDyScaleFactors false -m TT >& outputFromAnalysis/checkMuMuSignalWithSFs_TT.txt &"
##eval "./bin/analysis -c EE --ignoreDyScaleFactors false -m TT >& outputFromAnalysis/checkEESignalWithSFs_TT.txt &"

#all the plotting macros near the end of this script are designed to run over input files where electron SFs have been applied
#for r in ${!tAndPdatasetNames[*]}
#do
#	eval "./bin/analysis --c MuMu --ignoreDyScaleFactors false --isTagAndProbe true --m ${tAndPdatasetNames[$r]} >& outputFromAnalysis/checkMuMuDYTandPWithSFs_${tAndPdatasetNames[$r]}.txt &"
#	eval "./bin/analysis --c EE --ignoreDyScaleFactors false --isTagAndProbe true --m ${tAndPdatasetNames[$r]} >& outputFromAnalysis/checkEEDYTandPWithSFs_${tAndPdatasetNames[$r]}.txt &"
#done

##W dataset is WJets
#for r in ${!sidebandDatasetNames[*]}
#do
#	eval "./bin/analysis -c MuMu --ignoreDyScaleFactors false --isLowDiLepton true -m ${sidebandDatasetNames[$r]} >& outputFromAnalysis/checkMuMuLowDileptonMassWithSFs_${sidebandDatasetNames[$r]}.txt &"
#	eval "./bin/analysis -c EE --ignoreDyScaleFactors false --isLowDiLepton true -m ${sidebandDatasetNames[$r]} >& outputFromAnalysis/checkEELowDileptonMassWithSFs_${sidebandDatasetNames[$r]}.txt &" 
#	eval "./bin/analysis -c EMu --ignoreDyScaleFactors false -m ${sidebandDatasetNames[$r]} >& outputFromAnalysis/checkEMuWithSFs_${sidebandDatasetNames[$r]}.txt &"
#done
...
#leadLeptCutVals=('33.0' '35.0' '35.0' '37.0' '37.0' '40.0' '40.0')
#subleadLeptCutVals=('31.0' '33.0' '35.0' '33.0' '35.0' '35.0' '40.0')
#
