...
jetCutVals=('-10.0' '0.0' '10.0' '20.0' '30.0' '35.0' '40.0' '45.0' '50.0')
...
leadLeptCutVals=('33.0' '33.0' '33.0' '33.0' '35.0' '35.0' '35.0' '37.0' '37.0' '37.0' '40.0' '40.0' '40.0')
subleadLeptCutVals=('20.0' '25.0' '27.0' '29.0' '27.0' '29.0' '31.0' '29.0' '31.0' '33.0' '31.0' '33.0' '35.0')
for e in ${!jetCutVals[*]}
do
