...
#bsub -R "pool>2000" -q 1nh -J runAnalysisDYMadHTBinnedMCPart_NNN < runAnalysisDYMadHTBinnedMC_NNN.sh
...
eval "cmsRun test/genAndRecoDYJets_onlyMadHTBinnedXXX_cfg_NNN.py"
