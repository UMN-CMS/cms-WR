...
#bsub -R "rusage[mem=8000]" -q 8nh -J wrMuMu < runWrSignalMuMuJob.sh
#to request 8 GB ram
...
eval 'make'
eval "./bin/analysis -m signal -c MuMu --toys 200 --nStatToys 200"
eval "mv ./selected_tree_WRtoMuMuJJ_*signal_mumuMuMu.root $finalDir/."
